...
from source_code.rag.file_loader import Loader
from source_code.rag.vectorstore import VectorDB
from source_code.rag.offline_rag import Offline_RAG

class InputQA(BaseModel):
  question: str = Field(..., title="Question to ask the model")

class OutputQA(BaseModel):
  answer: str = Field(..., title="Answer from the question")
